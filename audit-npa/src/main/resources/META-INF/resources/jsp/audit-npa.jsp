...
<head>
    ...
    <title>Базовая страница</title>
       ...
       <link href="./js/audit-npa/favicon.ico" rel="icon" type="image/x-icon">
       
       
       <link href="modules/audit-npa/css/core.css" rel="stylesheet">
...
<route-app>
    ...
    <script src="./modules/audit-npa/js/manifest.js" type="text/javascript"></script>
